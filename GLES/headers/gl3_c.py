...
try:
  def glGetInternalformativ(target, internalformat, pname, bufSize, param0, target_t=GLenum, internalformat_t=GLenum,
                            pname_t=GLenum, bufSize_t=GLsizei, param0_t=GLint):
    restype = None
...
__all__ = [
  ...
  'glGetInternalformativ', 'GL_FRAMEBUFFER_ATTACHMENT_BLUE_SIZE', 'GL_UNSIGNED_INT_VEC2', 'GL_UNSIGNED_INT_VEC3',
  'GL_UNSIGNED_INT_VEC4', 'GL_UNSIGNED_SHORT_5_6_5', 'GL_VERTEX_ATTRIB_ARRAY_SIZE', 'GL_DEPTH_ATTACHMENT', 'GL_DITHER',
  'GL_TRANSFORM_FEEDBACK_PAUSED', 'GL_RGB16UI', '__gl3_h_', 'GL_QUERY_RESULT', 'GL_FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE',
  'GL_FLOAT_VEC2', 'GL_FLOAT_VEC3', 'GL_FLOAT_VEC4', 'GL_FLOAT', 'GL_INT_2_10_10_10_REV', 'GL_RGB32UI',
  'GL_TEXTURE_MAX_LOD', 'GL_BUFFER_MAP_OFFSET', 'GL_BUFFER_SIZE', 'GL_RGB9_E5', 'GL_UNIFORM_BUFFER_START',
  'GL_COMPRESSED_R11_EAC', 'GL_RGBA32UI', 'GL_UNSIGNED_INT_SAMPLER_2D', 'GL_TEXTURE_MIN_LOD', 'GL_TEXTURE8',
  'GL_TEXTURE9', 'GL_TEXTURE4', 'GL_TEXTURE5', 'GL_TEXTURE6', 'GL_TEXTURE7', 'GL_TEXTURE0', 'GL_LINEAR_MIPMAP_LINEAR',
  'GL_TEXTURE2', 'GL_TEXTURE3', 'GL_TEXTURE_CUBE_MAP_POSITIVE_Y', 'GL_TEXTURE_CUBE_MAP_POSITIVE_X', 'GL_BLEND_EQUATION',
  'GL_BYTE', 'GL_BOOL_VEC3', 'GL_BOOL_VEC2', 'GL_TIMEOUT_IGNORED', 'GL_MAX_VARYING_VECTORS', 'GL_RENDERBUFFER_SAMPLES',
  'GL_ONE', 'GL_RG', 'GL_COLOR_CLEAR_VALUE', 'GL_MAX_SAMPLES', 'GL_BUFFER_USAGE', 'GL_UNPACK_IMAGE_HEIGHT',
  'GL_FLOAT_MAT3x2', 'GL_TRIANGLE_STRIP', 'GL_PROGRAM_BINARY_RETRIEVABLE_HINT', 'GL_TRANSFORM_FEEDBACK_BUFFER_BINDING',
  'GL_FLOAT_MAT3x4', 'GL_COLOR_ATTACHMENT28', 'GL_COLOR_ATTACHMENT29', 'GL_COLOR_ATTACHMENT24', 'GL_COLOR_ATTACHMENT25',
  'GL_COLOR_ATTACHMENT26', 'GL_COLOR_ATTACHMENT27', 'GL_COLOR_ATTACHMENT20', 'GL_COLOR_ATTACHMENT21',
  'GL_COLOR_ATTACHMENT22', 'GL_COLOR_ATTACHMENT23', 'GL_TRANSFORM_FEEDBACK_BUFFER', 'GL_BLUE',
  'GL_VERTEX_ARRAY_BINDING', 'GL_UNSIGNED_SHORT_5_5_5_1', 'GL_TIMEOUT_EXPIRED', 'GL_COMPRESSED_RGB8_ETC2',
  'GL_SIGNED_NORMALIZED', 'GL_STENCIL_FUNC', 'GL_MAX_TEXTURE_LOD_BIAS', 'GL_ALIASED_LINE_WIDTH_RANGE', 'GL_DECR',
  'GL_BACK', 'GL_ES_VERSION_3_0', 'GL_TEXTURE_COMPARE_FUNC', 'GL_TRANSFORM_FEEDBACK_BUFFER_MODE', 'GL_INT',
  'GL_COMPRESSED_SIGNED_RG11_EAC', 'GL_POLYGON_OFFSET_FILL', 'GL_MINOR_VERSION', 'GL_FRONT_AND_BACK', 'GL_R8',
  'GL_RGB_INTEGER', 'GL_STENCIL', 'GL_SRGB', 'GL_GREEN_BITS', 'GL_SYNC_FENCE', 'GL_ONE_MINUS_CONSTANT_COLOR',
  'GL_SHADING_LANGUAGE_VERSION', 'GL_RGB8_SNORM', 'GL_UNPACK_SKIP_PIXELS', 'GL_TEXTURE_IMMUTABLE_LEVELS',
  'GL_FRAGMENT_SHADER', 'GL_UNSIGNED_INT_2_10_10_10_REV', 'GL_UNSIGNED_SHORT_4_4_4_4',
  'GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS', 'GL_FRAGMENT_SHADER_DERIVATIVE_HINT', 'GL_NO_ERROR', 'GL_VIEWPORT',
  'GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME', 'GL_BLEND_SRC_ALPHA', 'GL_DRAW_BUFFER6', 'GL_DRAW_BUFFER7',
  'GL_DRAW_BUFFER4', 'GL_DRAW_BUFFER5', 'GL_DRAW_BUFFER2', 'GL_DRAW_BUFFER3', 'GL_DRAW_BUFFER0', 'GL_DRAW_BUFFER1',
  'GL_UNIFORM_TYPE', 'GL_QUERY_RESULT_AVAILABLE', 'GL_DRAW_BUFFER8', 'GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT',
  'GL_MAX_DRAW_BUFFERS', 'GL_KEEP', 'GL_DELETE_STATUS', 'GL_R32UI', 'GL_RGBA8_SNORM', 'GL_INT_SAMPLER_3D',
  'GL_SRC_COLOR', 'GL_SAMPLER_BINDING', 'GL_DEPTH24_STENCIL8', 'GL_SAMPLE_BUFFERS', 'GL_MAJOR_VERSION',
  'GL_STATIC_COPY', 'GL_ACTIVE_ATTRIBUTE_MAX_LENGTH', 'GL_EXTENSIONS', 'GL_UNIFORM_BUFFER_BINDING', 'GL_RGBA16UI',
  'GL_COPY_READ_BUFFER_BINDING', 'GL_TEXTURE_COMPARE_MODE', 'GL_ANY_SAMPLES_PASSED',
  'GL_FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE', 'GL_DEPTH_BUFFER_BIT', 'GL_STENCIL_BACK_PASS_DEPTH_FAIL', 'GL_UNIFORM_BUFFER',
  'GL_MAP_WRITE_BIT', 'GL_VERTEX_ATTRIB_ARRAY_POINTER', 'GL_ALIASED_POINT_SIZE_RANGE', 'GL_CCW',
  'GL_MAP_INVALIDATE_BUFFER_BIT', 'GL_DEPTH_COMPONENT24', 'GL_UNSIGNED_INT_5_9_9_9_REV', 'GL_DEPTH_TEST',
  'GL_SYNC_GPU_COMMANDS_COMPLETE', 'GL_VERTEX_ATTRIB_ARRAY_INTEGER', 'GL_MAX_FRAGMENT_UNIFORM_BLOCKS',
  'GL_FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE', 'GL_ACTIVE_UNIFORM_MAX_LENGTH', 'GL_STREAM_READ', 'GL_LINEAR',
  'GL_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN', 'GL_FUNC_SUBTRACT', 'GL_R32F', 'GL_MAX_VARYING_COMPONENTS',
  'GL_ACTIVE_UNIFORM_BLOCK_MAX_NAME_LENGTH', 'GL_IMPLEMENTATION_COLOR_READ_FORMAT',
  'GL_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING', 'GL_HALF_FLOAT', 'GL_COLOR_ATTACHMENT15', 'GL_COLOR_ATTACHMENT14',
  'GL_HIGH_FLOAT', 'GL_DEPTH_RANGE', 'GL_GREATER', 'GL_CLAMP_TO_EDGE', 'GL_COLOR_ATTACHMENT13', 'GL_COLOR_ATTACHMENT12',
  'GL_NEAREST', 'GL_VERTEX_ATTRIB_ARRAY_ENABLED', 'GL_COLOR_ATTACHMENT19', 'GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER',
  'GL_MAX_TEXTURE_IMAGE_UNITS', 'GL_RGB32F', 'GL_FLOAT_MAT2', 'GL_FLOAT_MAT3', 'GL_FRONT_FACE', 'GL_DEPTH',
  'GL_FLOAT_MAT4', 'GL_RENDERBUFFER_GREEN_SIZE', 'GL_FRAMEBUFFER_ATTACHMENT_RED_SIZE',
  'GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT', 'GL_TEXTURE30', 'GL_TEXTURE31', 'GL_RG8I', 'GL_RGBA8I', 'GL_RG8UI',
  'GL_DEPTH_CLEAR_VALUE', 'GL_BUFFER_MAP_POINTER', 'GL_RENDERBUFFER_BINDING', 'GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE',
  'GL_STENCIL_REF', 'GL_MAX_3D_TEXTURE_SIZE', 'GL_R16UI', 'GL_COPY_WRITE_BUFFER_BINDING', 'GL_COPY_WRITE_BUFFER',
  'GL_BLEND', 'GL_MIRRORED_REPEAT', 'GL_SAMPLER_CUBE_SHADOW', 'GL_TEXTURE_BINDING_3D', 'GL_UNSIGNED_SHORT', 'GL_MIN',
  'GL_ONE_MINUS_DST_COLOR', 'GL_ONE_MINUS_SRC_COLOR', 'GL_TEXTURE', 'GL_COLOR_BUFFER_BIT', 'GL_DONT_CARE',
  'GL_ACTIVE_UNIFORMS', 'GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2', 'GL_MAX_VERTEX_UNIFORM_VECTORS',
  'GL_TEXTURE_BINDING_CUBE_MAP', 'GL_SAMPLER_2D', 'GL_INVALID_VALUE', 'GL_NEAREST_MIPMAP_NEAREST',
  'GL_NUM_COMPRESSED_TEXTURE_FORMATS', 'GL_PACK_SKIP_ROWS', 'GL_TEXTURE_MAG_FILTER', 'GL_R8I', 'GL_TEXTURE1',
  'GL_BLEND_EQUATION_RGB', 'GL_LINK_STATUS', 'GL_TEXTURE_MAX_LEVEL', 'GL_R32I', 'GL_BLEND_COLOR', 'GL_ALPHA_BITS',
  'GL_BOOL_VEC4', 'GL_ONE_MINUS_CONSTANT_ALPHA', 'GL_NEAREST_MIPMAP_LINEAR', 'GL_TEXTURE_CUBE_MAP_POSITIVE_Z',
  'GL_WAIT_FAILED', 'GL_UNIFORM_BLOCK_NAME_LENGTH', 'GL_MAX_TEXTURE_SIZE', 'GL_RG32F',
  'GL_UNSIGNED_INT_SAMPLER_2D_ARRAY', 'GL_ARRAY_BUFFER', 'GL_DEPTH_COMPONENT16', 'GL_UNSIGNALED', 'GL_RGB32I',
  'GL_BLEND_SRC_RGB', 'GL_FRAMEBUFFER_UNDEFINED', 'GL_SYNC_FLAGS', 'GL_FALSE',
  'GL_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS', 'GL_ONE_MINUS_SRC_ALPHA', 'GL_RG32I', 'GL_RENDERBUFFER_INTERNAL_FORMAT',
  'GL_NUM_SHADER_BINARY_FORMATS', 'GL_RGBA16I', 'GL_RGBA16F', 'GL_SAMPLE_ALPHA_TO_COVERAGE', 'GL_INT_SAMPLER_2D',
  'GL_STENCIL_BITS', 'GL_STENCIL_PASS_DEPTH_FAIL', 'GL_RED', 'GL_MAX_ELEMENT_INDEX', 'GL_MAX_VERTEX_UNIFORM_BLOCKS',
  'GL_FRAMEBUFFER_INCOMPLETE_DIMENSIONS', 'GL_RGBA8UI', 'GL_GREEN', 'GL_INVALID_OPERATION', 'GL_RED_INTEGER', 'GL_NONE',
  'GL_STENCIL_BACK_PASS_DEPTH_PASS', 'GL_COLOR_ATTACHMENT5', 'GL_FUNC_REVERSE_SUBTRACT', 'GL_COLOR_ATTACHMENT7',
  'GL_COLOR_ATTACHMENT6', 'GL_COLOR_ATTACHMENT1', 'GL_COLOR_ATTACHMENT0', 'GL_COLOR_ATTACHMENT3',
  'GL_COLOR_ATTACHMENT2', 'GL_UNIFORM_BLOCK_INDEX', 'GL_FRAMEBUFFER_DEFAULT', 'GL_COLOR_ATTACHMENT9',
  'GL_COLOR_ATTACHMENT8', 'GL_COLOR_ATTACHMENT10', 'GL_FRONT', 'GL_SCISSOR_BOX', 'GL_UNIFORM_BLOCK_DATA_SIZE',
  'GL_LEQUAL', 'GL_CULL_FACE_MODE', 'GL_MAX_FRAGMENT_UNIFORM_VECTORS', 'GL_NUM_EXTENSIONS', 'GL_UNIFORM_IS_ROW_MAJOR',
  'GL_MAX_UNIFORM_BLOCK_SIZE', 'GL_BOOL', 'GL_MAX_COMBINED_UNIFORM_BLOCKS', 'GL_FRAMEBUFFER_BINDING',
  'GL_UNSIGNED_INT_24_8', 'GL_COMPRESSED_TEXTURE_FORMATS', 'GL_ALPHA', 'GL_COLOR_WRITEMASK', 'GL_DST_COLOR',
  'GL_UNSIGNED_INT', 'GL_DEPTH_FUNC', 'GL_ALWAYS', 'GL_TEXTURE_WRAP_S', 'GL_TEXTURE_WRAP_T', 'GL_INVALID_ENUM',
  'GL_PROGRAM_BINARY_LENGTH', 'GL_STENCIL_BACK_VALUE_MASK', 'GL_INT_SAMPLER_2D_ARRAY', 'GL_COLOR_ATTACHMENT11',
  'GL_DEPTH_COMPONENT', 'GL_SCISSOR_TEST', 'GL_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES', 'GL_SHADER_TYPE',
  'GL_COMPARE_REF_TO_TEXTURE', 'GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE', 'GL_FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE',
  'GL_TRUE', 'GL_TEXTURE_MIN_FILTER', 'GL_REPLACE', 'GL_BLUE_BITS', 'GL_RG_INTEGER', 'GL_TEXTURE_SWIZZLE_R',
  'GL_VERTEX_ATTRIB_ARRAY_STRIDE', 'GL_EQUAL', 'GL_TEXTURE_SWIZZLE_G', 'GL_DEPTH_STENCIL_ATTACHMENT',
  'GL_RENDERBUFFER_HEIGHT', 'GL_RG16UI', 'GL_DRAW_BUFFER12', 'GL_TEXTURE_SWIZZLE_A', 'GL_LOW_FLOAT',
  'GL_MAX_FRAGMENT_UNIFORM_COMPONENTS', 'GL_FLOAT_MAT4x3', 'GL_DRAW_BUFFER15', 'GL_DYNAMIC_COPY', 'GL_STENCIL_BACK_REF',
  'GL_UNPACK_ALIGNMENT', 'GL_ALREADY_SIGNALED', 'GL_LINE_STRIP', 'GL_STREAM_COPY', 'GL_PACK_ROW_LENGTH',
  'GL_NUM_SAMPLE_COUNTS', 'GL_MEDIUM_INT', 'GL_TEXTURE_CUBE_MAP', 'GL_UNIFORM_BLOCK_ACTIVE_UNIFORMS', 'GL_COLOR',
  'GL_RENDERBUFFER_DEPTH_SIZE', 'GL_DYNAMIC_READ', 'GL_PROGRAM_BINARY_FORMATS', 'GL_LOW_INT', 'GL_DEPTH_STENCIL',
  'GL_VERTEX_ATTRIB_ARRAY_DIVISOR', 'GL_MAX_VERTEX_OUTPUT_COMPONENTS', 'GL_POINTS', 'GL_COMPRESSED_RG11_EAC',
  'GL_RENDERBUFFER_BLUE_SIZE', 'GL_UNIFORM_NAME_LENGTH', 'GL_FASTEST', 'GL_SYNC_CONDITION', 'GL_TEXTURE_2D',
  'GL_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS', 'GL_MAP_INVALIDATE_RANGE_BIT', 'GL_TEXTURE23', 'GL_TEXTURE22',
  'GL_TEXTURE21', 'GL_TEXTURE20', 'GL_TEXTURE27', 'GL_TEXTURE26', 'GL_TEXTURE25', 'GL_TEXTURE24', 'GL_R8_SNORM',
  'GL_TEXTURE29', 'GL_TEXTURE28', 'GL_ELEMENT_ARRAY_BUFFER_BINDING', 'GL_TEXTURE_CUBE_MAP_NEGATIVE_Y',
  'GL_TEXTURE_CUBE_MAP_NEGATIVE_X', 'GL_TEXTURE_CUBE_MAP_NEGATIVE_Z', 'GL_LINE_LOOP', 'GL_READ_BUFFER',
  'GL_MAP_FLUSH_EXPLICIT_BIT', 'GL_PACK_SKIP_PIXELS', 'GL_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS', 'GL_SUBPIXEL_BITS',
  'GL_SRGB8', 'GL_GEQUAL', 'GL_UNIFORM_BLOCK_BINDING', 'GL_UNIFORM_BUFFER_OFFSET_ALIGNMENT', 'GL_LINE_WIDTH',
  'GL_UNIFORM_OFFSET', 'GL_R16F', 'GL_REPEAT', 'GL_TRANSFORM_FEEDBACK', 'GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC',
  'GL_UNSIGNED_INT_SAMPLER_CUBE', 'GL_COLOR_ATTACHMENT4', 'GL_UNIFORM_SIZE', 'GL_FUNC_ADD', 'GL_FLOAT_MAT4x2',
  'GL_SHADER_SOURCE_LENGTH', 'GL_CURRENT_VERTEX_ATTRIB', 'GL_ARRAY_BUFFER_BINDING', 'GL_POLYGON_OFFSET_UNITS',
  'GL_DYNAMIC_DRAW', 'GL_OUT_OF_MEMORY', 'GL_NICEST', 'GL_IMPLEMENTATION_COLOR_READ_TYPE', 'GL_UNPACK_ROW_LENGTH',
  'GL_CURRENT_PROGRAM', 'GL_BUFFER_MAPPED', 'GL_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS', 'GL_RASTERIZER_DISCARD',
  'GL_NUM_PROGRAM_BINARY_FORMATS', 'GL_STREAM_DRAW', 'GL_UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER',
  'GL_MAX_UNIFORM_BUFFER_BINDINGS', 'GL_SIGNALED', 'GL_FRAMEBUFFER', 'GL_MEDIUM_FLOAT', 'GL_STENCIL_TEST',
  'GL_R11F_G11F_B10F', 'GL_LUMINANCE_ALPHA', 'GL_PIXEL_UNPACK_BUFFER_BINDING', 'GL_INVERT', 'GL_STENCIL_BACK_FAIL',
  'GL_POLYGON_OFFSET_FACTOR', 'GL_TRANSFORM_FEEDBACK_VARYINGS', 'GL_DEPTH_COMPONENT32F', 'GL_TRIANGLE_FAN',
  'GL_SYNC_FLUSH_COMMANDS_BIT', 'GL_ONE_MINUS_DST_ALPHA', 'GL_DRAW_FRAMEBUFFER_BINDING', 'GL_MAX_ELEMENTS_VERTICES',
  'GL_STENCIL_BACK_WRITEMASK', 'GL_INVALID_FRAMEBUFFER_OPERATION', 'GL_BUFFER_ACCESS_FLAGS',
  'GL_COMPRESSED_RGBA8_ETC2_EAC', 'GL_UNIFORM_BUFFER_SIZE', 'GL_TRIANGLES', 'GL_SAMPLER_2D_ARRAY_SHADOW',
  'GL_DEPTH32F_STENCIL8', 'GL_MAX_ARRAY_TEXTURE_LAYERS', 'GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING',
  'GL_UNIFORM_MATRIX_STRIDE', 'GL_MAX_SERVER_WAIT_TIMEOUT', 'GL_SRGB8_ALPHA8', 'GL_PACK_ALIGNMENT',
  'GL_SAMPLER_2D_ARRAY', 'GL_RENDERER', 'GL_MAX_COLOR_ATTACHMENTS', 'GL_ACTIVE_UNIFORM_BLOCKS', 'GL_UNPACK_SKIP_IMAGES',
  'GL_STENCIL_BACK_FUNC', 'GL_RGB16I', 'GL_ACTIVE_TEXTURE', 'GL_TEXTURE_BASE_LEVEL', 'GL_INTERLEAVED_ATTRIBS',
  'GL_RGB16F', 'GL_COMPRESSED_SIGNED_R11_EAC', 'GL_UNSIGNED_INT_SAMPLER_3D', 'GL_TRANSFORM_FEEDBACK_VARYING_MAX_LENGTH',
  'GL_TEXTURE_WRAP_R', 'GL_INT_VEC4', 'GL_INT_VEC3', 'GL_INT_VEC2', 'GL_STENCIL_FAIL', 'GL_MAX_VERTEX_ATTRIBS',
  'GL_CONDITION_SATISFIED', 'GL_TEXTURE_IMMUTABLE_FORMAT', 'GL_FRAMEBUFFER_UNSUPPORTED', 'GL_DST_ALPHA', 'GL_LESS',
  'GL_MAX_CUBE_MAP_TEXTURE_SIZE', 'GL_RGB565', 'GL_TRANSFORM_FEEDBACK_BINDING', 'GL_RENDERBUFFER_WIDTH',
  'GL_READ_FRAMEBUFFER_BINDING', 'GL_RGBA4', 'GL_DRAW_BUFFER10', 'GL_DRAW_BUFFER11', 'GL_RGBA8', 'GL_DRAW_BUFFER13',
  'GL_DRAW_BUFFER14', 'GL_LUMINANCE', 'GL_INFO_LOG_LENGTH', 'GL_DEPTH_WRITEMASK', 'GL_PRIMITIVE_RESTART_FIXED_INDEX',
  'GL_SRC_ALPHA_SATURATE', 'GL_RENDERBUFFER_STENCIL_SIZE', 'GL_CONSTANT_ALPHA', 'GL_R16I', 'GL_RG8_SNORM',
  'GL_PIXEL_PACK_BUFFER', 'GL_STATIC_READ', 'GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2',
  'GL_UNIFORM_BLOCK_REFERENCED_BY_FRAGMENT_SHADER', 'GL_VALIDATE_STATUS', 'GL_MAP_READ_BIT', 'GL_STENCIL_CLEAR_VALUE',
  'GL_STENCIL_BUFFER_BIT', 'GL_TEXTURE_SWIZZLE_B', 'GL_COLOR_ATTACHMENT17', 'GL_BLEND_EQUATION_ALPHA',
  'GL_RGBA_INTEGER', 'GL_ACTIVE_ATTRIBUTES', 'GL_MAX_RENDERBUFFER_SIZE', 'GL_COLOR_ATTACHMENT31',
  'GL_COLOR_ATTACHMENT30', 'GL_STENCIL_PASS_DEPTH_PASS', 'GL_INCR_WRAP', 'GL_RENDERBUFFER_ALPHA_SIZE', 'GL_HIGH_INT',
  'GL_COLOR_ATTACHMENT16', 'GL_DECR_WRAP', 'GL_ATTACHED_SHADERS', 'GL_MAX_FRAGMENT_INPUT_COMPONENTS',
  'GL_SAMPLE_COVERAGE_INVERT', 'GL_LINES', 'GL_TEXTURE18', 'GL_TEXTURE19', 'GL_TEXTURE16', 'GL_TEXTURE17',
  'GL_TEXTURE14', 'GL_GENERATE_MIPMAP_HINT', 'GL_TEXTURE12', 'GL_TEXTURE13', 'GL_TEXTURE10', 'GL_UNPACK_SKIP_ROWS',
  'GL_BLEND_DST_ALPHA', 'GL_RGB', 'GL_INT_SAMPLER_CUBE', 'GL_CURRENT_QUERY', 'GL_VERTEX_ATTRIB_ARRAY_NORMALIZED',
  'GL_RGB5_A1', 'GL_VERTEX_SHADER', 'GL_TRANSFORM_FEEDBACK_BUFFER_START', 'GL_MAX_PROGRAM_TEXEL_OFFSET',
  ...
  'GL_ES_VERSION_2_0', 'GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE', 'GL_VERSION', 'GL_MAP_UNSYNCHRONIZED_BIT',
  'GL_ZERO', 'GL_ELEMENT_ARRAY_BUFFER', 'GL_SYNC_STATUS', 'GL_BUFFER_MAP_LENGTH', 'GL_MAX_ELEMENTS_INDICES',
  'GL_UNSIGNED_NORMALIZED', 'GL_SRC_ALPHA', 'GL_TEXTURE_3D', 'GL_FIXED', 'GL_RGB8', 'GL_NOTEQUAL',
  'GL_UNIFORM_ARRAY_STRIDE', 'GL_FLOAT_32_UNSIGNED_INT_24_8_REV', 'GL_INCR', 'GL_CULL_FACE', 'GL_SAMPLE_COVERAGE_VALUE',
  'GL_RENDERBUFFER_RED_SIZE', 'GL_MAX_VIEWPORT_DIMS', 'GL_RG32UI', 'GL_NEVER', 'GL_TEXTURE15', 'GL_STENCIL_VALUE_MASK',
  'GL_DRAW_BUFFER9', 'GL_COMPILE_STATUS', 'GL_FRAMEBUFFER_COMPLETE', 'GL_TEXTURE11', 'GL_COPY_READ_BUFFER',
  'GL_SHADER_COMPILER', 'GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS', 'GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS', 'GL_RGBA',
  'GL_SHORT', 'GL_READ_FRAMEBUFFER', 'GL_CW', 'GL_MIN_PROGRAM_TEXEL_OFFSET', 'GL_UNSIGNED_BYTE',
  'GL_MAX_VERTEX_UNIFORM_COMPONENTS', 'GL_VENDOR', 'GL_TEXTURE_2D_ARRAY', 'GL_UNSIGNED_INT_10F_11F_11F_REV',
  'GL_TEXTURE_BINDING_2D', 'GL_OBJECT_TYPE', 'GL_R8UI', 'GL_STATIC_DRAW', 'GL_RENDERBUFFER', 'GL_FLOAT_MAT2x3',
  'GL_FRAMEBUFFER_ATTACHMENT_GREEN_SIZE', 'GL_FLOAT_MAT2x4', 'GL_RGB8I', 'GL_COLOR_ATTACHMENT18',
  'GL_TRANSFORM_FEEDBACK_BUFFER_SIZE', 'GL_TRANSFORM_FEEDBACK_ACTIVE', 'GL_SEPARATE_ATTRIBS', 'GL_SAMPLER_3D', 'GL_MAX',
  'GL_STENCIL_INDEX8', 'GL_DEPTH_BITS', 'GL_RGB8UI', 'GL_INVALID_INDEX', 'GL_COMPRESSED_SRGB8_ETC2', 'GL_BLEND_DST_RGB',
  'GL_SAMPLER_2D_SHADOW', 'GL_TEXTURE_BINDING_2D_ARRAY', 'GL_RG16F', 'GL_SAMPLER_CUBE',
  'GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL', 'GL_RED_BITS', 'GL_RG16I', 'GL_PIXEL_PACK_BUFFER_BINDING',
  'GL_STENCIL_ATTACHMENT', 'GL_SAMPLE_COVERAGE', 'GL_ANY_SAMPLES_PASSED_CONSERVATIVE', 'GL_DRAW_FRAMEBUFFER',
  'GL_RGB10_A2UI', 'GL_SAMPLES', 'GLchar', 'GLenum', 'GLboolean', 'GLbitfield', 'GLbyte', 'GLshort', 'GLint', 'GLint64',
  'GLsizei', 'GLubyte', 'GLushort', 'GLuint', 'GLfloat', 'GLclampf', 'GLfixed', 'GLintptr', 'GLsizeiptr', 'GLclampx',
  'void', 'GLvoid', 'GLsync', 'GLeglImageOES', 'GLDEBUGPROCKHR', 'GLuint64']
