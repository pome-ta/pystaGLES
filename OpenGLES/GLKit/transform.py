...
class GLKEffectPropertyTransform:
  ...
  invModelviewMatrixLoc = property(getInvModelviewMatrixLoc,
                                   setInvModelviewMatrixLoc)

  def setInvModelviewMatrix(self, imvm):
    self._trans.setInvModelviewMatrix_(
      imvm, argtypes=[GLKMatrix4], restype=None)
  ...
  projectionMatrixLoc = property(getProjectionMatrixLoc,
