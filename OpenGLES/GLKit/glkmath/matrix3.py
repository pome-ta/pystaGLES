...
def GLKMatrix3MakeAndTranspose(m00, m01, m02, m10, m11, m12, m20, m21, m22):
  return GLKMatrix3Transpose(
    GLKMatrix3Make(m00, m01, m02, m10, m11, m12, m20, m21, m22))
...
def GLKMatrix3Transpose(matrix):
  matrix = GLKMatrix3MakeWithArray([
    matrix.m[0], matrix.m[3], matrix.m[6], matrix.m[1], matrix.m[4],
    matrix.m[7], matrix.m[2], matrix.m[5], matrix.m[8]
  ])
  return matrix
...
__all__ = [
  'GLKMatrix3', 'GLKMatrix3Make', 'GLKMatrix3MakeIdentity',
  'GLKMatrix3MakeAndTranspose', 'GLKMatrix3MakeWithArray',
  'GLKMatrix3MakeWithArrayAndTranspose', 'GLKMatrix3MakeWithColumns',
  'GLKMatrix3MakeWithRows', 'GLKMatrix3MakeRotation',
  'GLKMatrix3MakeXRotation', 'GLKMatrix3MakeYRotation',
  'GLKMatrix3MakeZRotation', 'GLKMatrix3MakeWithQuaternion',
  'GLKMatrix3MakeScale', 'GLKMatrix3GetMatrix2', 'GLKMatrix3GetColumn',
  'GLKMatrix3GetRow', 'GLKMatrix3SetColumn', 'GLKMatrix3SetRow',
  'GLKMatrix3Invert', 'GLKMatrix3Transpose', 'GLKMatrix3InvertAndTranspose',
  'GLKMatrix3Multiply'
]
