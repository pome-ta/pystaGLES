...
def GLKQuaternionMakeWithAngleAndAxis(radians, x, y, z):
  ...
  return GLKQuaternionMake(scale * x, scale * y, scale * z,
                           math.cos(halfAngle))


def GLKQuaternionMakeWithAngleAndVector3Axis(radians, axisVector):
  return GLKQuaternionMakeWithAngleAndAxis(radians, axisVector.v[0],
                                           axisVector.v[1], axisVector.v[2])
...
def GLKQuaternionMultiply(quaternionLeft, quaternionRight):
  array = [
    quaternionLeft.q[3] * quaternionRight.q[0] + quaternionLeft.q[0] *
    quaternionRight.q[3] + quaternionLeft.q[1] * quaternionRight.q[2] -
    quaternionLeft.q[2] * quaternionRight.q[1],
    quaternionLeft.q[3] * quaternionRight.q[1] + quaternionLeft.q[1] *
    quaternionRight.q[3] + quaternionLeft.q[2] * quaternionRight.q[0] -
    quaternionLeft.q[0] * quaternionRight.q[2],
    quaternionLeft.q[3] * quaternionRight.q[2] + quaternionLeft.q[2] *
    quaternionRight.q[3] + quaternionLeft.q[0] * quaternionRight.q[1] -
    quaternionLeft.q[1] * quaternionRight.q[0],
    quaternionLeft.q[3] * quaternionRight.q[3] - quaternionLeft.q[0] *
    quaternionRight.q[0] - quaternionLeft.q[1] * quaternionRight.q[1] -
    quaternionLeft.q[2] * quaternionRight.q[2]
  ]
  return GLKQuaternionMakeWithArray(array)
...
def GLKQuaternionNormalize(quaternion):
  ...
  return GLKQuaternionMakeWithArray([
    quaternion.q[0] * scale, quaternion.q[1] * scale, quaternion.q[2] * scale,
    quaternion.q[3] * scale
  ])


def GLKQuaternionRotateVector3(quaternion, vector):
  rotatedQuaternion = GLKQuaternionMake(vector.v[0], vector.v[1], vector.v[2],
                                        0.0)
  rotatedQuaternion = GLKQuaternionMultiply(
    GLKQuaternionMultiply(quaternion, rotatedQuaternion),
    GLKQuaternionInvert(quaternion))

  return vector3.GLKVector3Make(rotatedQuaternion.q[0], rotatedQuaternion.q[1],
                                rotatedQuaternion.q[2])
...
def GLKQuaternionRotateVector4(quaternion, vector):
  ...
  return vector4.GLKVector4Make(rotatedQuaternion.q[0], rotatedQuaternion.q[1],
                                rotatedQuaternion.q[2], vector.v[3])


__all__ = [
  'GLKQuaternion', 'GLKQuaternionMake', 'GLKQuaternionMakeWithVector3',
  'GLKQuaternionMakeWithArray', 'GLKQuaternionMakeWithAngleAndAxis',
  'GLKQuaternionMakeWithAngleAndVector3Axis', 'GLKQuaternionAdd',
  'GLKQuaternionSubtract', 'GLKQuaternionMultiply', 'GLKQuaternionLength',
  'GLKQuaternionConjugate', 'GLKQuaternionInvert', 'GLKQuaternionNormalize',
  'GLKQuaternionRotateVector3', 'GLKQuaternionRotateVector4'
]
