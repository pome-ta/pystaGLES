...
class stpq(ctypes.Structure):
  _fields_ = [('s', ctypes.c_float), ('t', ctypes.c_float),
              ('p', ctypes.c_float), ('q', ctypes.c_float)]
...
__all__ = [
  'GLKVector4', 'getGLKVector4', 'setGLKVector4', 'GLKVector4Make',
  'GLKVector4MakeWithArray', 'GLKVector4MakeWithVector3', 'GLKVector4Length',
  'GLKVector4Distance', 'GLKVector4Negate', 'GLKVector4Normalize',
  'GLKVector4AddScalar', 'GLKVector4SubtractScalar',
  'GLKVector4MultiplyScalar', 'GLKVector4DivideScalar', 'GLKVector4Add',
  'GLKVector4Subtract', 'GLKVector4Multiply', 'GLKVector4Divide',
  'GLKVector4DotProduct', 'GLKVector4CrossProduct', 'GLKVector4Lerp',
  'GLKVector4Project', 'GLKVector4Maximum', 'GLKVector4Minimum',
  'GLKVector4EqualToScalar', 'GLKVector4AllEqualToVector4',
  'GLKVector4AllGreaterThanOrEqualToScalar',
  'GLKVector4AllGreaterThanOrEqualToVector4', 'GLKVector4AllGreaterThanScalar',
