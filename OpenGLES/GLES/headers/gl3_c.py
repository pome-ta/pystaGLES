...
try:
  ...
  def glBindAttribLocation(program,
                           index,
                           param0,
                           program_t=GLuint,
                           index_t=GLuint,
...
try:
  ...
  def glBlendEquationSeparate(modeRGB,
                              modeAlpha,
                              modeRGB_t=GLenum,
                              modeAlpha_t=GLenum):
    restype = None
...
try:
  ...
  def glBlendFuncSeparate(sfactorRGB,
                          dfactorRGB,
                          sfactorAlpha,
                          dfactorAlpha,
                          sfactorRGB_t=GLenum,
                          dfactorRGB_t=GLenum,
                          sfactorAlpha_t=GLenum,
                          dfactorAlpha_t=GLenum):
    restype = None
...
try:
  ...
  def glFramebufferRenderbuffer(target,
                                attachment,
                                renderbuffertarget,
                                renderbuffer,
                                target_t=GLenum,
...
try:
  ...
  def glFramebufferTexture2D(target,
                             attachment,
                             textarget,
                             texture,
                             level,
...
try:
  ...
  def glGetActiveAttrib(program,
    ...
    restype = None
    argtypes = [
      program_t, index_t, bufSize_t, param0_t, param1_t, param2_t, param3_t
    ]
...
try:
  ...
  def glGetActiveUniform(program,
                         index,
                         bufSize,
                         param0,
                         param1,
...
try:
  ...
  def glGetFramebufferAttachmentParameteriv(target,
                                            attachment,
                                            pname,
                                            param0,
                                            target_t=GLenum,
...
try:
  ...
  def glGetRenderbufferParameteriv(target,
                                   pname,
                                   param0,
                                   target_t=GLenum,
                                   pname_t=GLenum,
...
try:
  ...
  def glGetShaderPrecisionFormat(shadertype,
                                 precisiontype,
                                 param0,
                                 param1,
                                 shadertype_t=GLenum,
                                 precisiontype_t=GLenum,
                                 param0_t=GLint,
                                 param1_t=GLint):
    restype = None
...
try:
  ...
  def glGetVertexAttribPointerv(index,
                                pname,
                                voidpointer,
                                index_t=GLuint,
                                pname_t=GLenum,
...
try:
  ...
  def glRenderbufferStorage(target,
                            internalformat,
                            width,
                            height,
                            target_t=GLenum,
...
try:
  ...
  def glStencilFuncSeparate(face,
                            func,
                            ref,
                            mask,
                            face_t=GLenum,
...
try:
  ...
  def glUniformMatrix2fv(location,
                         count,
                         transpose,
                         param0,
                         location_t=GLint,
...
try:
  ...
  def glUniformMatrix3fv(location,
                         count,
                         transpose,
                         param0,
                         location_t=GLint,
...
try:
  ...
  def glUniformMatrix4fv(location,
                         count,
                         transpose,
                         param0,
                         location_t=GLint,
...
try:
  ...
  def glVertexAttribPointer(index,
                            size,
                            type,
                            normalized,
                            stride,
...
try:
  ...
  def glCopyTexSubImage3D(target,
                          level,
                          xoffset,
                          yoffset,
                          zoffset,
...
try:
  ...
  def glCompressedTexImage3D(target,
                             level,
                             internalformat,
                             width,
                             height,
...
try:
  ...
  def glCompressedTexSubImage3D(target,
                                level,
                                xoffset,
                                yoffset,
                                zoffset,
...
try:
  ...
  def glGetBufferPointerv(target,
                          pname,
                          voidparams,
                          target_t=GLenum,
                          pname_t=GLenum,
...
try:
  ...
  def glUniformMatrix2x3fv(location,
                           count,
                           transpose,
                           param0,
                           location_t=GLint,
...
try:
  ...
  def glUniformMatrix3x2fv(location,
                           count,
                           transpose,
                           param0,
                           location_t=GLint,
...
try:
  ...
  def glUniformMatrix2x4fv(location,
                           count,
                           transpose,
                           param0,
                           location_t=GLint,
...
try:
  ...
  def glUniformMatrix4x2fv(location,
                           count,
                           transpose,
                           param0,
                           location_t=GLint,
...
try:
  ...
  def glUniformMatrix3x4fv(location,
                           count,
                           transpose,
                           param0,
                           location_t=GLint,
...
try:
  ...
  def glUniformMatrix4x3fv(location,
                           count,
                           transpose,
                           param0,
                           location_t=GLint,
...
try:
  ...
  def glRenderbufferStorageMultisample(target,
                                       samples,
                                       internalformat,
                                       width,
                                       height,
...
try:
  ...
  def glFramebufferTextureLayer(target,
                                attachment,
                                texture,
                                level,
                                layer,
...
try:
  ...
  def glFlushMappedBufferRange(target,
                               offset,
                               length,
                               target_t=GLenum,
                               offset_t=GLintptr,
...
try:
  ...
  def glTransformFeedbackVaryings(program,
                                  count,
                                  param0,
                                  bufferMode,
                                  program_t=GLuint,
...
try:
  ...
  def glGetTransformFeedbackVarying(program,
                                    index,
                                    bufSize,
                                    param0,
                                    param1,
...
try:
  ...
  def glVertexAttribIPointer(index,
                             size,
                             type,
                             stride,
                             voidpointer,
...
try:
  ...
  def glGetVertexAttribIiv(index,
                           pname,
                           param0,
                           index_t=GLuint,
                           pname_t=GLenum,
...
try:
  ...
  def glGetVertexAttribIuiv(index,
                            pname,
                            param0,
                            index_t=GLuint,
                            pname_t=GLenum,
...
try:
  ...
  def glGetFragDataLocation(program, param0, program_t=GLuint,
                            param0_t=GLchar):
    restype = GLint
    argtypes = [program_t, param0_t]
...
try:
  ...
  def glCopyBufferSubData(readTarget,
                          writeTarget,
                          readOffset,
                          writeOffset,
                          size,
...
try:
  ...
  def glGetUniformIndices(program,
                          uniformCount,
                          param0,
                          param1,
                          program_t=GLuint,
                          uniformCount_t=GLsizei,
                          param0_t=GLchar,
                          param1_t=GLuint):
    restype = None
...
try:
  ...
  def glGetActiveUniformsiv(program,
                            uniformCount,
                            param0,
                            pname,
                            param1,
...
try:
  ...
  def glGetUniformBlockIndex(program,
                             param0,
                             program_t=GLuint,
                             param0_t=GLchar):
    restype = GLuint
...
try:
  ...
  def glGetActiveUniformBlockiv(program,
                                uniformBlockIndex,
                                pname,
                                param0,
                                program_t=GLuint,
                                uniformBlockIndex_t=GLuint,
                                pname_t=GLenum,
                                param0_t=GLint):
    restype = None
...
try:
  ...
  def glGetActiveUniformBlockName(program,
                                  uniformBlockIndex,
                                  bufSize,
                                  param0,
                                  param1,
...
try:
  ...
  def glUniformBlockBinding(program,
                            uniformBlockIndex,
                            uniformBlockBinding,
                            program_t=GLuint,
                            uniformBlockIndex_t=GLuint,
                            uniformBlockBinding_t=GLuint):
    restype = None
...
try:
  ...
  def glDrawArraysInstanced(mode,
                            first,
                            count,
                            instancecount,
                            mode_t=GLenum,
...
try:
  ...
  def glDrawElementsInstanced(mode,
                              count,
                              type,
                              voidindices,
                              instancecount,
...
try:
  ...
  def glGetBufferParameteri64v(target,
                               pname,
                               param0,
                               target_t=GLenum,
                               pname_t=GLenum,
...
try:
  ...
  def glSamplerParameteri(sampler,
                          pname,
                          param,
                          sampler_t=GLuint,
                          pname_t=GLenum,
...
try:
  ...
  def glSamplerParameteriv(sampler,
                           pname,
                           param0,
                           sampler_t=GLuint,
                           pname_t=GLenum,
...
try:
  ...
  def glSamplerParameterf(sampler,
                          pname,
                          param,
                          sampler_t=GLuint,
                          pname_t=GLenum,
...
try:
  ...
  def glSamplerParameterfv(sampler,
                           pname,
                           param0,
                           sampler_t=GLuint,
                           pname_t=GLenum,
...
try:
  ...
  def glGetSamplerParameteriv(sampler,
                              pname,
                              param0,
                              sampler_t=GLuint,
                              pname_t=GLenum,
...
try:
  ...
  def glGetSamplerParameterfv(sampler,
                              pname,
                              param0,
                              sampler_t=GLuint,
                              pname_t=GLenum,
...
try:
  ...
  def glProgramParameteri(program,
                          pname,
                          value,
                          program_t=GLuint,
                          pname_t=GLenum,
...
try:
  ...
  def glInvalidateFramebuffer(target,
                              numAttachments,
                              param0,
                              target_t=GLenum,
...
try:
  ...
  def glInvalidateSubFramebuffer(target,
                                 numAttachments,
                                 param0,
                                 x,
                                 y,
    ...
    restype = None
    argtypes = [
      target_t, numAttachments_t, param0_t, x_t, y_t, width_t, height_t
    ]
...
try:
  ...
  def glGetInternalformativ(target,
                            internalformat,
                            pname,
                            count,
                            param0,
...
__all__ = [
  ...
  'glIsShader', 'glIsTexture', 'glLineWidth', 'glLinkProgram', 'glPixelStorei',
  'glPolygonOffset', 'glReadPixels', 'glReleaseShaderCompiler',
  ...
  'glTexParameteriv', 'glTexSubImage2D', 'glUniform1f', 'glUniform1fv',
  ...
  'glUseProgram', 'glValidateProgram', 'glVertexAttrib1f', 'glVertexAttrib1fv',
  'glVertexAttrib2f', 'glVertexAttrib2fv', 'glVertexAttrib3f',
  'glVertexAttrib3fv', 'glVertexAttrib4f', 'glVertexAttrib4fv',
  'glVertexAttribPointer', 'glViewport', 'glReadBuffer', 'glDrawRangeElements',
  'glTexImage3D', 'glTexSubImage3D', 'glCopyTexSubImage3D',
  'glCompressedTexImage3D', 'glCompressedTexSubImage3D', 'glGenQueries',
  'glDeleteQueries', 'glIsQuery', 'glBeginQuery', 'glEndQuery', 'glGetQueryiv',
  ...
  'glFlushMappedBufferRange', 'glBindVertexArray', 'glDeleteVertexArrays',
  'glGenVertexArrays', 'glIsVertexArray', 'glGetIntegeri_v',
  ...
  'glGetUniformuiv', 'glGetFragDataLocation', 'glUniform1ui', 'glUniform2ui',
  'glUniform3ui', 'glUniform4ui', 'glUniform1uiv', 'glUniform2uiv',
  'glUniform3uiv', 'glUniform4uiv', 'glClearBufferiv', 'glClearBufferuiv',
  'glClearBufferfv', 'glClearBufferfi', 'glCopyBufferSubData',
  'glGetUniformIndices', 'glGetActiveUniformsiv', 'glGetUniformBlockIndex',
  'glGetActiveUniformBlockiv', 'glGetActiveUniformBlockName',
  'glUniformBlockBinding', 'glDrawArraysInstanced', 'glDrawElementsInstanced',
  ...
  'glSamplerParameterfv', 'glGetSamplerParameteriv', 'glGetSamplerParameterfv',
  ...
  'glGetInternalformativ', '__gles2_gl3_h_', 'GL_GLES_PROTOTYPES',
  'GL_ES_VERSION_2_0', 'GL_DEPTH_BUFFER_BIT', 'GL_STENCIL_BUFFER_BIT',
  ...
  'GL_ONE_MINUS_DST_COLOR', 'GL_SRC_ALPHA_SATURATE', 'GL_FUNC_ADD',
  'GL_BLEND_EQUATION', 'GL_BLEND_EQUATION_RGB', 'GL_BLEND_EQUATION_ALPHA',
  'GL_FUNC_SUBTRACT', 'GL_FUNC_REVERSE_SUBTRACT', 'GL_BLEND_DST_RGB',
  ...
  'GL_CULL_FACE_MODE', 'GL_FRONT_FACE', 'GL_DEPTH_RANGE', 'GL_DEPTH_WRITEMASK',
  ...
  'GL_STENCIL_WRITEMASK', 'GL_STENCIL_BACK_FUNC', 'GL_STENCIL_BACK_FAIL',
  ...
  'GL_ACTIVE_ATTRIBUTE_MAX_LENGTH', 'GL_SHADING_LANGUAGE_VERSION',
  'GL_CURRENT_PROGRAM', 'GL_NEVER', 'GL_LESS', 'GL_EQUAL', 'GL_LEQUAL',
  'GL_GREATER', 'GL_NOTEQUAL', 'GL_GEQUAL', 'GL_ALWAYS', 'GL_KEEP',
  'GL_REPLACE', 'GL_INCR', 'GL_DECR', 'GL_INVERT', 'GL_INCR_WRAP',
  ...
  'GL_TEXTURE_WRAP_S', 'GL_TEXTURE_WRAP_T', 'GL_TEXTURE', 'GL_TEXTURE_CUBE_MAP',
  'GL_TEXTURE_BINDING_CUBE_MAP', 'GL_TEXTURE_CUBE_MAP_POSITIVE_X',
  'GL_TEXTURE_CUBE_MAP_NEGATIVE_X', 'GL_TEXTURE_CUBE_MAP_POSITIVE_Y',
  'GL_TEXTURE_CUBE_MAP_NEGATIVE_Y', 'GL_TEXTURE_CUBE_MAP_POSITIVE_Z',
  'GL_TEXTURE_CUBE_MAP_NEGATIVE_Z', 'GL_MAX_CUBE_MAP_TEXTURE_SIZE',
  ...
  'GL_TEXTURE30', 'GL_TEXTURE31', 'GL_ACTIVE_TEXTURE', 'GL_REPEAT',
  'GL_CLAMP_TO_EDGE', 'GL_MIRRORED_REPEAT', 'GL_FLOAT_VEC2', 'GL_FLOAT_VEC3',
  'GL_FLOAT_VEC4', 'GL_INT_VEC2', 'GL_INT_VEC3', 'GL_INT_VEC4', 'GL_BOOL',
  'GL_BOOL_VEC2', 'GL_BOOL_VEC3', 'GL_BOOL_VEC4', 'GL_FLOAT_MAT2',
  'GL_FLOAT_MAT3', 'GL_FLOAT_MAT4', 'GL_SAMPLER_2D', 'GL_SAMPLER_CUBE',
  ...
  'GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING', 'GL_IMPLEMENTATION_COLOR_READ_TYPE',
  'GL_IMPLEMENTATION_COLOR_READ_FORMAT', 'GL_COMPILE_STATUS',
  'GL_INFO_LOG_LENGTH', 'GL_SHADER_SOURCE_LENGTH', 'GL_SHADER_COMPILER',
  'GL_SHADER_BINARY_FORMATS', 'GL_NUM_SHADER_BINARY_FORMATS', 'GL_LOW_FLOAT',
  'GL_MEDIUM_FLOAT', 'GL_HIGH_FLOAT', 'GL_LOW_INT', 'GL_MEDIUM_INT',
  'GL_HIGH_INT', 'GL_FRAMEBUFFER', 'GL_RENDERBUFFER', 'GL_RGBA4', 'GL_RGB5_A1',
  ...
  'GL_RENDERBUFFER_STENCIL_SIZE', 'GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE',
  'GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME',
  'GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL',
  'GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE', 'GL_COLOR_ATTACHMENT0',
  'GL_DEPTH_ATTACHMENT', 'GL_STENCIL_ATTACHMENT', 'GL_NONE',
  ...
  'GL_ES_VERSION_3_0', 'GL_READ_BUFFER', 'GL_UNPACK_ROW_LENGTH',
  'GL_UNPACK_SKIP_ROWS', 'GL_UNPACK_SKIP_PIXELS', 'GL_PACK_ROW_LENGTH',
  'GL_PACK_SKIP_ROWS', 'GL_PACK_SKIP_PIXELS', 'GL_COLOR', 'GL_DEPTH',
  'GL_STENCIL', 'GL_RED', 'GL_RGB8', 'GL_RGBA8', 'GL_RGB10_A2',
  'GL_TEXTURE_BINDING_3D', 'GL_UNPACK_SKIP_IMAGES', 'GL_UNPACK_IMAGE_HEIGHT',
  'GL_TEXTURE_3D', 'GL_TEXTURE_WRAP_R', 'GL_MAX_3D_TEXTURE_SIZE',
  'GL_UNSIGNED_INT_2_10_10_10_REV', 'GL_MAX_ELEMENTS_VERTICES',
  'GL_MAX_ELEMENTS_INDICES', 'GL_TEXTURE_MIN_LOD', 'GL_TEXTURE_MAX_LOD',
  'GL_TEXTURE_BASE_LEVEL', 'GL_TEXTURE_MAX_LEVEL', 'GL_MIN', 'GL_MAX',
  'GL_DEPTH_COMPONENT24', 'GL_MAX_TEXTURE_LOD_BIAS', 'GL_TEXTURE_COMPARE_MODE',
  'GL_TEXTURE_COMPARE_FUNC', 'GL_CURRENT_QUERY', 'GL_QUERY_RESULT',
  'GL_QUERY_RESULT_AVAILABLE', 'GL_BUFFER_MAPPED', 'GL_BUFFER_MAP_POINTER',
  'GL_STREAM_READ', 'GL_STREAM_COPY', 'GL_STATIC_READ', 'GL_STATIC_COPY',
  'GL_DYNAMIC_READ', 'GL_DYNAMIC_COPY', 'GL_MAX_DRAW_BUFFERS',
  ...
  'GL_DRAW_BUFFER15', 'GL_MAX_FRAGMENT_UNIFORM_COMPONENTS',
  'GL_MAX_VERTEX_UNIFORM_COMPONENTS', 'GL_SAMPLER_3D', 'GL_SAMPLER_2D_SHADOW',
  'GL_FRAGMENT_SHADER_DERIVATIVE_HINT', 'GL_PIXEL_PACK_BUFFER',
  ...
  'GL_SRGB', 'GL_SRGB8', 'GL_SRGB8_ALPHA8', 'GL_COMPARE_REF_TO_TEXTURE',
  'GL_MAJOR_VERSION', 'GL_MINOR_VERSION', 'GL_NUM_EXTENSIONS', 'GL_RGBA32F',
  'GL_RGB32F', 'GL_RGBA16F', 'GL_RGB16F', 'GL_VERTEX_ATTRIB_ARRAY_INTEGER',
  'GL_MAX_ARRAY_TEXTURE_LAYERS', 'GL_MIN_PROGRAM_TEXEL_OFFSET',
  'GL_MAX_PROGRAM_TEXEL_OFFSET', 'GL_MAX_VARYING_COMPONENTS',
  'GL_TEXTURE_2D_ARRAY', 'GL_TEXTURE_BINDING_2D_ARRAY', 'GL_R11F_G11F_B10F',
  'GL_UNSIGNED_INT_10F_11F_11F_REV', 'GL_RGB9_E5',
  'GL_UNSIGNED_INT_5_9_9_9_REV', 'GL_TRANSFORM_FEEDBACK_VARYING_MAX_LENGTH',
  ...
  'GL_RED_INTEGER', 'GL_RGB_INTEGER', 'GL_RGBA_INTEGER', 'GL_SAMPLER_2D_ARRAY',
  ...
  'GL_UNSIGNED_INT_SAMPLER_2D_ARRAY', 'GL_BUFFER_ACCESS_FLAGS',
  'GL_BUFFER_MAP_LENGTH', 'GL_BUFFER_MAP_OFFSET', 'GL_DEPTH_COMPONENT32F',
  ...
  'GL_FRAMEBUFFER_UNDEFINED', 'GL_DEPTH_STENCIL_ATTACHMENT', 'GL_DEPTH_STENCIL',
  'GL_UNSIGNED_INT_24_8', 'GL_DEPTH24_STENCIL8', 'GL_UNSIGNED_NORMALIZED',
  'GL_DRAW_FRAMEBUFFER_BINDING', 'GL_READ_FRAMEBUFFER', 'GL_DRAW_FRAMEBUFFER',
  'GL_READ_FRAMEBUFFER_BINDING', 'GL_RENDERBUFFER_SAMPLES',
  'GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER', 'GL_MAX_COLOR_ATTACHMENTS',
  ...
  'GL_COLOR_ATTACHMENT31', 'GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE',
  'GL_MAX_SAMPLES', 'GL_HALF_FLOAT', 'GL_MAP_READ_BIT', 'GL_MAP_WRITE_BIT',
  'GL_MAP_INVALIDATE_RANGE_BIT', 'GL_MAP_INVALIDATE_BUFFER_BIT',
  'GL_MAP_FLUSH_EXPLICIT_BIT', 'GL_MAP_UNSYNCHRONIZED_BIT', 'GL_RG',
  'GL_RG_INTEGER', 'GL_R8', 'GL_RG8', 'GL_R16F', 'GL_R32F', 'GL_RG16F',
  'GL_RG32F', 'GL_R8I', 'GL_R8UI', 'GL_R16I', 'GL_R16UI', 'GL_R32I', 'GL_R32UI',
  'GL_RG8I', 'GL_RG8UI', 'GL_RG16I', 'GL_RG16UI', 'GL_RG32I', 'GL_RG32UI',
  'GL_VERTEX_ARRAY_BINDING', 'GL_R8_SNORM', 'GL_RG8_SNORM', 'GL_RGB8_SNORM',
  'GL_RGBA8_SNORM', 'GL_SIGNED_NORMALIZED', 'GL_PRIMITIVE_RESTART_FIXED_INDEX',
  'GL_COPY_READ_BUFFER', 'GL_COPY_WRITE_BUFFER', 'GL_COPY_READ_BUFFER_BINDING',
  'GL_COPY_WRITE_BUFFER_BINDING', 'GL_UNIFORM_BUFFER',
  'GL_UNIFORM_BUFFER_BINDING', 'GL_UNIFORM_BUFFER_START',
  ...
  'GL_WAIT_FAILED', 'GL_SYNC_FLUSH_COMMANDS_BIT', 'GL_TIMEOUT_IGNORED',
  'GL_VERTEX_ATTRIB_ARRAY_DIVISOR', 'GL_ANY_SAMPLES_PASSED',
  'GL_ANY_SAMPLES_PASSED_CONSERVATIVE', 'GL_SAMPLER_BINDING', 'GL_RGB10_A2UI',
  'GL_TEXTURE_SWIZZLE_R', 'GL_TEXTURE_SWIZZLE_G', 'GL_TEXTURE_SWIZZLE_B',
  'GL_TEXTURE_SWIZZLE_A', 'GL_GREEN', 'GL_BLUE', 'GL_INT_2_10_10_10_REV',
  'GL_TRANSFORM_FEEDBACK', 'GL_TRANSFORM_FEEDBACK_PAUSED',
  'GL_TRANSFORM_FEEDBACK_ACTIVE', 'GL_TRANSFORM_FEEDBACK_BINDING',
  ...
  'GL_TEXTURE_IMMUTABLE_FORMAT', 'GL_MAX_ELEMENT_INDEX',
  'GL_NUM_SAMPLE_COUNTS', 'GL_TEXTURE_IMMUTABLE_LEVELS', 'GLchar', 'GLenum',
