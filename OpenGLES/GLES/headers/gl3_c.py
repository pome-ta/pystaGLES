...
try:
    def glGetInternalformativ(target, internalformat, pname, count, param0, target_t=GLenum, internalformat_t=GLenum, pname_t=GLenum, count_t=GLsizei, param0_t=GLint):
        restype = None
