...
class GLKTextureLoader:
  ...
  def textureFromFile(self, path):
    ...
    callback = CBlock(test, restype=None, argtypes=None)

    self._loader.textureWithContentsOfFile_options_queue_completionHandler_(
      path, DEFAULTS, None, test)
  ...
  def textureFromURL(self, path):
    ...
    self._loader.textureWithContentsOfURL_options_queue_completionHandler_(
      url, DEFAULTS, None, test)


positions = [
  ES.GL_TEXTURE0, ES.GL_TEXTURE1, ES.GL_TEXTURE2, ES.GL_TEXTURE3,
  ES.GL_TEXTURE4, ES.GL_TEXTURE5, ES.GL_TEXTURE6, ES.GL_TEXTURE7,
  ES.GL_TEXTURE8, ES.GL_TEXTURE9, ES.GL_TEXTURE10, ES.GL_TEXTURE11,
  ES.GL_TEXTURE12, ES.GL_TEXTURE13, ES.GL_TEXTURE14, ES.GL_TEXTURE15,
  ES.GL_TEXTURE16, ES.GL_TEXTURE17, ES.GL_TEXTURE18, ES.GL_TEXTURE19,
  ES.GL_TEXTURE20, ES.GL_TEXTURE21, ES.GL_TEXTURE22, ES.GL_TEXTURE23,
  ES.GL_TEXTURE24, ES.GL_TEXTURE25, ES.GL_TEXTURE26, ES.GL_TEXTURE27,
  ES.GL_TEXTURE28, ES.GL_TEXTURE29, ES.GL_TEXTURE30, ES.GL_TEXTURE31
]
