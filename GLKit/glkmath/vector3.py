...
def GLKVector3Distance(vectorStart, vectorEnd):
  ...
  return math.sqrt(
    math.pow(vectorStart.x - vectorEnd.x, 2) + math.pow(
      vectorStart.y - vectorEnd.y, 2) + math.pow(vectorStart.z - vectorEnd.z,
                                                 2))
...
__all__ = [
  'GLKVector3', 'setGLKVector3', 'getGLKVector3', 'GLKVector3Make',
  'GLKVector3MakeWithArray', 'GLKVector3Length', 'GLKVector3Distance',
  'GLKVector3Negate', 'GLKVector3Normalize', 'GLKVector3AddScalar',
  'GLKVector3SubtractScalar', 'GLKVector3MultiplyScalar',
  'GLKVector3DivideScalar', 'GLKVector3Add', 'GLKVector3Subtract',
  'GLKVector3Multiply', 'GLKVector3Divide', 'GLKVector3DotProduct',
  'GLKVector3CrossProduct', 'GLKVector3Lerp', 'GLKVector3Project',
  'GLKVector3Maximum', 'GLKVector3Minimum', 'GLKVector3EqualToScalar',
  'GLKVector3AllEqualToVector4', 'GLKVector3AllGreaterThanOrEqualToScalar',
  'GLKVector3AllGreaterThanOrEqualToVector4', 'GLKVector3AllGreaterThanScalar',
  'GLKVector3AllGreaterThanVector4'
]
