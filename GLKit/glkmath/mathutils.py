...
__all__ = [
  'GLKMathDegreesToRadians', 'GLKMathRadiansToDegrees', 'GLKMathProject',
  'GLKMathUnproject', 'NSStringFromGLKMatrix2', 'NSStringFromGLKMatrix3',
  'NSStringFromGLKMatrix4', 'NSStringFromGLKVector2', 'NSStringFromGLKVector3',
  'NSStringFromGLKVector4', 'NSStringFromGLKQuaternion'
]

if __name__ == '__main__':
  m = matrix4.GLKMatrix4Identity()
  print(NSStringFromGLKMatrix4(m))
  q = quaternion.GLKQuaternionNormalize(
